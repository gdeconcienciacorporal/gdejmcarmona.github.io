...
const dataLine1 = {
  ...
  datasets: [{
    label: 'Km recorridos en Semana 11 km',
    data: [15, 24, 17, 26], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    label: 'Total Km recorridos en Semana 12 km',
    data: [13, 12, 12, 20], // Datos de los km recorridos en cada día
