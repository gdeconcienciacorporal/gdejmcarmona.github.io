...
const dataLine1 = {
  ...
  datasets: [{
    label: 'Km recorridos en Semana 9: 82 km',
    data: [12, 15, 25, 30], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    label: 'Total Km recorridos en Semana 10: 80 km',
    data: [14, 17, 25, 24], // Datos de los km recorridos en cada día
